...
OBJ_RULES = text_utilities.o Settings.o Game.o Bird.o Log.o LogPair.o World.o StateMachine.o TitleScreenState.o CountDownState.o PlayingState.o PauseState.o NormalMode.o HardMode.o StaticLog.o MovingLog.o
...
StaticLog.o: src/StaticLog.cpp src/StaticLog.hpp
	$(CXX) -c $(INCLUDE) $< -o $(BUILD_DIR)/$@
...
NormalMode.o: src/strategies/NormalMode.cpp src/strategies/NormalMode.hpp
	$(CXX) -c $(INCLUDE) $< -o $(BUILD_DIR)/$@

HardMode.o: src/strategies/HardMode.cpp src/strategies/HardMode.hpp
	$(CXX) -c $(INCLUDE) $< -o $(BUILD_DIR)/$@

MovingLog.o: src/MovingLog.cpp src/MovingLog.hpp
	$(CXX) -c $(INCLUDE) $< -o $(BUILD_DIR)/$@
